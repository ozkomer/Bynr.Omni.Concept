...
using Bynr.Omni.Concept.Core.Extensions;
using Bynr.Omni.Concept.Core.MessageBrokers.Concrete.RabbitMQ.EasyNetQ;
using Bynr.Omni.Concept.Core.Settings.Concrete.MessageBrokers;
